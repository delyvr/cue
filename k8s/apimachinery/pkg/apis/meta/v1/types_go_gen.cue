...
#TypeMeta: {
	...
	// More info: https://git.github.com/delyvr/cue/k8s/community/contributors/devel/sig-architecture/api-conventions.md#resources
	// +optional
...
#ObjectMeta: {
	...
	// More info: https://git.github.com/delyvr/cue/k8s/community/contributors/devel/sig-architecture/api-conventions.md#idempotency
	// +optional
	...
	// +optional
	uid?: types.#UID @go(UID) @protobuf(5,bytes,opt,casttype=github.com/delyvr/cue/k8s/kubernetes/pkg/types.UID)
...
#StatusDetails: {
	...
	// More info: http://kubernetes.io/docs/user-guide/identifiers#uids
	// +optional
	uid?: types.#UID @go(UID) @protobuf(6,bytes,opt,casttype=github.com/delyvr/cue/k8s/apimachinery/pkg/types.UID)
...
//
// The exact format is defined in sigs.github.com/delyvr/cue/k8s/structured-merge-diff
// +protobuf.options.(gogoproto.goproto_stringer)=false
#FieldsV1: {
}
