...
import (
	metav1 "github.com/delyvr/cue/k8s/apimachinery/pkg/apis/meta/v1"
	"github.com/delyvr/cue/k8s/apimachinery/pkg/api/resource"
	"github.com/delyvr/cue/k8s/apimachinery/pkg/util/intstr"
	"github.com/delyvr/cue/k8s/apimachinery/pkg/types"
)
...
#VolumeSource: {
	...
	// kubelet's host machine and then exposed to the pod.
	// More info: https://examples.github.com/delyvr/cue/k8s/volumes/iscsi/README.md
	// +optional
	iscsi?: null | #ISCSIVolumeSource @go(ISCSI,*ISCSIVolumeSource) @protobuf(8,bytes,opt)

	// Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime.
	// More info: https://examples.github.com/delyvr/cue/k8s/volumes/glusterfs/README.md
	// +optional
	...
	// More info: https://examples.github.com/delyvr/cue/k8s/volumes/rbd/README.md
	// +optional
	...
	// More info: https://examples.github.com/delyvr/cue/k8s/mysql-cinder-pd/README.md
	// +optional
...
#PersistentVolumeSource: {
	...
	// More info: https://examples.github.com/delyvr/cue/k8s/volumes/storageos/README.md
	// +optional
...
#PersistentVolume: {
	...
	// More info: https://git.github.com/delyvr/cue/k8s/community/contributors/devel/sig-architecture/api-conventions.md#metadata
	// +optional
...
#PersistentVolumeList: {
	...
	// More info: https://git.github.com/delyvr/cue/k8s/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
	// +optional
...
#PersistentVolumeClaimSpec: {
	...
	// * An existing VolumeSnapshot object (snapshot.storage.github.com/delyvr/cue/k8s/VolumeSnapshot)
...
#GlusterfsVolumeSource: {
	...
	// More info: https://examples.github.com/delyvr/cue/k8s/volumes/glusterfs/README.md#create-a-pod
...
#RBDVolumeSource: {
	...
	// More info: https://examples.github.com/delyvr/cue/k8s/volumes/rbd/README.md#how-to-use-it
...
#CephFSVolumeSource: {
	...
	// More info: https://examples.github.com/delyvr/cue/k8s/volumes/cephfs/README.md#how-to-use-it
...
#PodSpec: {
	...
	// More info: https://git.github.com/delyvr/cue/k8s/enhancements/keps/sig-network/0007-pod-ready%2B%2B.md
	// +optional
	...
	// More info: https://git.github.com/delyvr/cue/k8s/enhancements/keps/sig-node/runtime-class.md
	...
	// More info: https://git.github.com/delyvr/cue/k8s/enhancements/keps/sig-node/20190226-pod-overhead.md
...
#PodStatus: {
	...
	// More info: https://git.github.com/delyvr/cue/k8s/community/contributors/design-proposals/node/resource-qos.md
	// +optional
...
#PodStatusResult: {
	...
	// Populated by the system.
	// Read-only.
	// More info: https://git.github.com/delyvr/cue/k8s/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
	// +optional
...
#PodList: {
	...
	// List of pods.
	// More info: https://git.github.com/delyvr/cue/k8s/community/contributors/devel/sig-architecture/api-conventions.md
...
#PodTemplate: {
	...
	// https://git.github.com/delyvr/cue/k8s/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
	// +optional
...
#ReplicationController: {
	...
	// Standard object's metadata. More info: https://git.github.com/delyvr/cue/k8s/community/contributors/devel/sig-architecture/api-conventions.md#metadata
	// +optional
	metadata?: metav1.#ObjectMeta @go(ObjectMeta) @protobuf(1,bytes,opt)
...
#NodeSpec: {
	...
	// see: https://issues.github.com/delyvr/cue/k8s/61966
	// +optional
...
#NodeStatus: {
	...
	// use a full-replacement patch. See http://pr.github.com/delyvr/cue/k8s/79391 for an example.
	// +optional
	// +patchMergeKey=type
	// +patchStrategy=merge
...
#Preconditions: {
	...
	// +optional
	uid?: null | types.#UID @go(UID,*types.UID) @protobuf(1,bytes,opt,casttype=github.com/delyvr/cue/k8s/apimachinery/pkg/types.UID)
}
...
#ObjectReference: {
	...
	// +optional
	uid?: types.#UID @go(UID) @protobuf(4,bytes,opt,casttype=github.com/delyvr/cue/k8s/apimachinery/pkg/types.UID)
	...
	// More info: https://git.github.com/delyvr/cue/k8s/community/contributors/devel/sig-architecture/api-conventions.md#concurrency-control-and-consistency
	// +optional
