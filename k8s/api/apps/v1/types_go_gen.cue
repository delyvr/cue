...
import (
	...
	"github.com/delyvr/cue/k8s/api/core/v1"
...
#StatefulSetCondition: {
	...
	status: v1.#ConditionStatus @go(Status) @protobuf(2,bytes,opt,casttype=github.com/delyvr/cue/k8s/api/core/v1.ConditionStatus)
